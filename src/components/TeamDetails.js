import { faCaretDown, faCog, faEdit, faTrash } from '@fortawesome/free-solid-svg-icons'
                                    ...
                                    <tr>
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 pb-6 pl-6 text-right">
                                            <div className="relative">
                                                <button
                                                    className="inline-block outline-none focus:outline-none align-middle transition-all duration-150 ease-in-out uppercase border border-solid font-bold last:mr-0 mr-2  text-slate-800 bg-white border-white active:bg-slate-100 active:border-slate-100 text-xs px-3 py-2 shadow hover:shadow-md rounded-md"
