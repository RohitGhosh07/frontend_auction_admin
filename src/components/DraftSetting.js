                        ...
                        <div class="relative flex flex-col w-full mb-6 shadow-lg rounded-lg bg-white">
                            <div class="mb-0 p-6 pb-0">
                                <div class="text-center flex justify-between items-center">
                                    <h6 class="text-xl font-bold mb-0">Draft Settings</h6>
                                        ...
                                        <div class="flex flex-wrap -mx-4">
                                            <div class="w-full px-4 lg:w-6/12">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <div class="mb-3 pt-0"><input placeholder="Username" type="text" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="lucky.jesse" /></div>
                                                </div>
                                            </div>
                                            <div class="w-full px-4 lg:w-6/12">
                                                <div class="relative w-full mb-3">
                                                    <label class="block uppercase text-slate-500 text-xs font-bold mb-2 ml-1" for="grid-password">Generate New Column</label>
                                                    <div class="mb-3 pt-0"><input placeholder="Email" type="email" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="jesse@example.com" /></div>
                                                </div>
                                            </div>
                                            <div class="w-full px-4 lg:w-6/12">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <div class="mb-3 pt-0"><input placeholder="First Name" type="text" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="Lucky" /></div>
                                                </div>
                                            </div>
                                            <div class="w-full px-4 lg:w-6/12">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <div class="mb-3 pt-0"><input placeholder="Last Name" type="text" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="Jesse" /></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex flex-wrap -mx-4">
                                            <div class="w-full px-4 lg:w-12/12">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <div class="mb-3 pt-0"><input placeholder="Address" type="text" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="Bld Mihail Kogalniceanu, nr. 8 Bl 1, Sc 1, Ap 09" /></div>
                                                </div>
                                            </div>
                                            <div class="w-full px-4 lg:w-4/12">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <div class="mb-3 pt-0"><input placeholder="City" type="text" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="New York" /></div>
                                                </div>
                                            </div>
                                            <div class="w-full px-4 lg:w-4/12">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <div class="mb-3 pt-0"><input placeholder="Country" type="text" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="United States" /></div>
                                                </div>
                                            </div>
                                            <div class="w-full px-4 lg:w-4/12">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <div class="mb-3 pt-0"><input placeholder="Postal Code" type="text" class="border-slate-300 px-3 py-2 text-sm  w-full placeholder-slate-200 text-slate-700 relative bg-white rounded-md outline-none focus:ring focus:ring-blue-500 focus:ring-1 focus:border-blue-500 border border-solid transition duration-200 " value="44444444" /></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
